function [active_nodes,G_duplicate] = independent_cascade(G,active_rounds,initial_nodes,activation_probability)
...
for i=1:active_rounds
    ...
    for individual = 1:length(active_nodes_last_round)
        ...
        Acommon = intersect(potential_infected,active_nodes_last_round);
    ...
    active_nodes=[active_nodes;active_nodes_current_round];
    length(active_nodes)
end
